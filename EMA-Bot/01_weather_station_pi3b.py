...
BLYNK_AUTH = "TXxZCeqcfno9bau_hf-J9MUM2NU2HR0N"
...
def read_handler(vpin):
    print("read_handler: V{}".format(vpin))

    try:
        blynk.virtual_write(T_VPIN, 12)
        print("temperture on {}: 12".format(T_VPIN))
        
    
    except Exception as e:
        print('[ERROR] read_handler: {}'.format(e))
